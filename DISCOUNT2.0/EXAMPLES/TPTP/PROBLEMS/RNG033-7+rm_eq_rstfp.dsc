...
NAME RNG033_7_rm_eq_rstfp_in

ORDERING XKBO
           add:1 > multiply:1 > commutator:1 > associator:1 > additive_inverse:1 > additive_identity:1 > w:1 > x:1 > y:1 > z:1
...
CONCLUSION add(associator(multiply(x,y),z,w),associator(x,y,commutator(z,w))) = add(multiply(x,associator(y,z,w)),multiply(associator(x,z,w),y))
