...
NAME LCL162_1_rm_eq_rstfp_in

ORDERING XKBO
           and_star:1 > implies:1 > xor:1 > false:1 > not:1 > true:1 > x:1 > y:1 > z:1
...
CONCLUSION implies(implies(x,y),implies(implies(y,z),implies(x,z))) = true
