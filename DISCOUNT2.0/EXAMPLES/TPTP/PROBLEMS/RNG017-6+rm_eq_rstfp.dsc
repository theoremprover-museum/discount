...
NAME RNG017_6_rm_eq_rstfp_in

ORDERING XKBO
           add:1 > multiply:1 > commutator:1 > associator:1 > additive_inverse:1 > additive_identity:1 > x:1 > y:1 > z:1
...
CONCLUSION multiply(additive_inverse(x),add(y,z)) = add(additive_inverse(multiply(x,y)),additive_inverse(multiply(x,z)))
