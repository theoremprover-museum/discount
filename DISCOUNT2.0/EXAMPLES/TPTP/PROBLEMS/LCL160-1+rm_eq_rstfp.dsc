...
NAME LCL160_1_rm_eq_rstfp_in

ORDERING XKBO
           and_star:1 > or:1 > implies:1 > xor:1 > and:1 > false:1 > not:1 > true:1 > x:1 > y:1
...
CONCLUSION and_star(xor(and_star(xor(true,x),y),true),y) = and_star(xor(and_star(xor(true,y),x),true),x)
