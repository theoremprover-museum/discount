...
NAME BOO005_2_rm_eq_rstfp_in

ORDERING XKBO
           add:1 > multiply:1 > additive_identity:1 > multiplicative_identity:1 > inverse:1 > a:1
...
CONCLUSION add(a,multiplicative_identity) = multiplicative_identity
