...
NAME GRP175_4_rm_eq_rstfp_in

ORDERING XKBO
           greatest_lower_bound:1 > least_upper_bound:1 > multiply:1 > identity:1 > b:1 > inverse:1 > a:1
...
CONCLUSION least_upper_bound(identity,multiply(inverse(a),multiply(b,a))) = multiply(inverse(a),multiply(b,a))
