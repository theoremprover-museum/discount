...
NAME GRP165_1_rm_eq_rstfp_in

ORDERING XKBO
           greatest_lower_bound:1 > least_upper_bound:1 > multiply:1 > identity:1 > a:1 > inverse:1
...
CONCLUSION least_upper_bound(a,multiply(a,a)) = multiply(a,a)
